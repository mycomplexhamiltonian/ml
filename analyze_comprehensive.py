...
def main():
    ...
    print("="*60)
    print("COMPREHENSIVE FINANCIAL ANALYSIS WITH MARKET CAP BUCKETING")
    print("="*60)
    ...
    plt.suptitle('Comprehensive Financial Analysis by Market Cap', fontsize=18, fontweight='bold', y=0.98)
    plt.tight_layout()
